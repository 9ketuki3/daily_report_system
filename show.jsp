            ...
            <c:when test="${report != null}">
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <th>いいね数</th>
                            <td><c:out value="${report.goodPoint}" /></td>
                        </tr>

                    </tbody>
                </table>
                <br>
                <form action="<c:url value='/reports/good' />" method="post">
                    この日報に<input type="hidden" name="id" value="${report.id}" />
                    <button type="submit">いいね！</button>
                    する
                </form><br>
                <c:if test="${flush2 != null}">
                    <div id="flush_success">
                        <c:out value="${flush2}"></c:out>
                    </div>
                </c:if>
